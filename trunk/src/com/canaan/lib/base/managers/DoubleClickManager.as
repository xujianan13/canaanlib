package com.canaan.lib.base.managers
{
	...
	{
		public static var delay:Number = 270;
...
class DoubleClickItem implements IRecyclable
{
	...
	public static function fromPool():DoubleClickItem {
		return ObjectPool.getObject(DoubleClickItem) as DoubleClickItem;
	}
	
	public static function toPool(doubleClickItem:DoubleClickItem):void {
		ObjectPool.disposeObject(doubleClickItem);
	}
}